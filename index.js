...
global.spider = bot	
const { autoFollowAtStartup } = require('./autoFollow');
...
console.log(color(`[ # ] 𝐄𝐧𝐭𝐞𝐫 𝐓𝐡𝐚𝐭 𝐂𝐨𝐝𝐞 𝐈𝐧𝐭𝐨 𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩 : ${code}`, `${randomcolor}`));
}
  ...
  memoryOnly: false 
	...
	bot.ev.on('messages.upsert', async chatUpdate => {
		try {
			...
			require("./spiderx")(bot, m, chatUpdate, mek, store)
		} catch (err) {
			console.log(chalk.yellow.bold("[ ERROR ] spiderx.js :\n") + chalk.redBright(util.format(err)))
		}
	})
